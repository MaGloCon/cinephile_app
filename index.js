...
const allowedOrigins = ['http://localhost:8080', 'http://localhost:49902', 'http://localhost:1234', 'https://cinephile-dc1b75a885d0.herokuapp.com/', 'https://cinephile-client.netlify.app'];
app.use(cors({
